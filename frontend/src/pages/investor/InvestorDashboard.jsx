    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col md:flex-row">
      ...
      <aside className="w-full md:w-64 bg-card border-b md:border-b-0 md:border-r border-border flex flex-col justify-between p-6">
        <div className="space-y-8">
          ...
          <nav className="space-y-1">
            ...
            <a href="#valuations" className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-muted-foreground hover:bg-muted/50 hover:text-foreground text-sm font-medium transition-colors">
              <Wallet className="h-4 w-4" /> Valuasi & Fundraising
            </a>
            <a href="#downloads" className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-muted-foreground hover:bg-muted/50 hover:text-foreground text-sm font-medium transition-colors">
      ...
      <main className="flex-1 p-6 md:p-10 space-y-8 overflow-y-auto">
        ...
        <header className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Investor Reporting Console</h1>
            <p className="text-muted-foreground mt-1">Akses eksklusif read-only ke proyeksi model finansial, skenario, dan valuasi koperasi/SME.</p>
          </div>
          {primaryCompany && (
