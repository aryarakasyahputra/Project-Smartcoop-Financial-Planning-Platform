    ...
    <div className="space-y-8 animate-fadeIn">
        ...
        <div className="pl-2 space-y-5">
          <div>
            <p className="text-[11px] font-extrabold text-[#005fa4] uppercase tracking-[0.2em] mb-1 flex items-center gap-1.5">
              <span className="h-1.5 w-1.5 rounded-full bg-[#FFD700]" /> Ringkasan Eksekutif
            </p>
            <h2 className="text-2xl font-extrabold text-slate-900 tracking-tight">Analisis Strategis & Rekomendasi</h2>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-3xl p-6 border border-slate-200/80 shadow-sm hover:shadow-md hover:border-[#005fa4]/30 transition-all duration-300 group">
          <p className="text-[11px] font-bold text-slate-400 uppercase tracking-widest mb-4 flex items-center justify-between">
            <span>CAGR Pendapatan (5-Tahun)</span>
          ...
          <p className="text-xs text-slate-500 font-medium">Laju pertumbuhan tahunan majemuk (2025–2029).</p>
        </div>
        
        {/* Metric 2 */}
        <div className="bg-white rounded-3xl p-6 border border-slate-200/80 shadow-sm hover:shadow-md hover:border-[#005fa4]/30 transition-all duration-300 group">
          <p className="text-[11px] font-bold text-slate-400 uppercase tracking-widest mb-4 flex items-center justify-between">
            <span>Milestone EBITDA Positif</span>
            <span className="h-1.5 w-1.5 rounded-full bg-[#FFD700]" />
          </p>
          <div className={`flex items-baseline gap-2 mb-2 ${insights.breakEvenYear === 'Belum Tercapai' ? 'text-red-500' : 'text-emerald-600'}`}>
            <span className={`font-black ${insights.breakEvenYear === 'Belum Tercapai' ? 'text-2xl text-red-500' : 'text-4xl text-emerald-600'}`}>{insights.breakEvenYear}</span>
            <Flag className="h-6 w-6" />
          </div>
          <p className="text-xs text-slate-500 font-medium">Tahun pertama EBITDA operasional bernilai positif.</p>
        </div>
        
        {/* Metric 3 */}
        <div className="bg-white rounded-3xl p-6 border border-slate-200/80 shadow-sm hover:shadow-md hover:border-[#005fa4]/30 transition-all duration-300 group">
          <p className="text-[11px] font-bold text-slate-400 uppercase tracking-widest mb-4 flex items-center justify-between">
            <span>LTV / CAC (Rata-rata 2025)</span>
            <span className="h-1.5 w-1.5 rounded-full bg-[#005fa4]" />
          </p>
          ...
          <p className="text-xs text-slate-500 font-medium">Rasio nilai kontribusi pelanggan dibanding beban akuisisi.</p>
        </div>
      </div>
      ...
      <section className="bg-white rounded-3xl shadow-sm border border-slate-200/80 p-6 md:p-8 space-y-6">
        <div className="flex items-start gap-4">
          ...
          <div>
            <h2 className="text-xl font-extrabold text-slate-900">Proyeksi Pengembalian Investor Seed</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="transform transition-all duration-300 hover:-translate-y-1 hover:shadow-md bg-gradient-to-br from-slate-50 to-slate-100/50 border border-slate-200 rounded-2xl p-6 relative overflow-hidden shadow-2xs cursor-default">
            <div className="flex justify-between items-center mb-6">
              <span className="text-xs font-extrabold text-slate-600 uppercase tracking-widest">Konservatif (3x)</span>
              <span className="text-[10px] bg-slate-200 text-slate-700 px-2 py-1 rounded-md font-extrabold uppercase">Exit 2029</span>
            </div>
            <div className="space-y-6">
              <div>
                <p className="text-[10px] text-slate-400 uppercase font-bold mb-1">Exit Valuation</p>
              ...
              <div className="grid grid-cols-2 border-t border-slate-200 pt-4 gap-4">
                ...
                <div>
                  <p className="text-[10px] text-slate-400 uppercase font-bold">IRR (5-Thn)</p>
          ...
          <div className="transform transition-all duration-300 hover:-translate-y-1 hover:shadow-xl bg-gradient-to-br from-[#005fa4]/5 via-white to-blue-50/30 border-2 border-[#005fa4]/40 rounded-2xl p-6 relative overflow-hidden ring-4 ring-[#005fa4]/5 shadow-md cursor-default">
            <div className="flex justify-between items-center mb-6">
              <span className="text-xs font-black text-[#005fa4] uppercase tracking-widest flex items-center gap-1.5">
                <ShieldCheck className="h-4 w-4 text-[#005fa4]" /> Base Case (5x)
              </span>
              <span className="text-[10px] bg-[#005fa4] text-white px-2.5 py-1 rounded-md font-extrabold uppercase shadow-2xs">Target Utama</span>
            </div>
            <div className="space-y-6">
              <div>
                <p className="text-[10px] text-[#005fa4] uppercase font-bold mb-1">Exit Valuation</p>
              ...
              <div className="grid grid-cols-2 border-t border-[#005fa4]/20 pt-4 gap-4">
                ...
                <div>
                  <p className="text-[10px] text-[#005fa4] uppercase font-bold">IRR (5-Thn)</p>
          ...
          <div className="transform transition-all duration-300 hover:-translate-y-1 hover:shadow-md bg-gradient-to-br from-[#FFD700]/10 via-white to-amber-50/20 border border-amber-300 rounded-2xl p-6 relative overflow-hidden shadow-2xs cursor-default">
            <div className="flex justify-between items-center mb-6">
              <span className="text-xs font-extrabold text-amber-800 uppercase tracking-widest flex items-center gap-1.5">
                <Award className="h-4 w-4 text-amber-600" /> Optimistik (7x)
              </span>
              <span className="text-[10px] bg-amber-500 text-white px-2 py-1 rounded-md font-extrabold uppercase">Exit 2029</span>
            </div>
            <div className="space-y-6">
              <div>
                <p className="text-[10px] text-amber-700 uppercase font-bold mb-1">Exit Valuation</p>
              ...
              <div className="grid grid-cols-2 border-t border-amber-200 pt-4 gap-4">
                ...
                <div>
                  <p className="text-[10px] text-amber-700 uppercase font-bold">IRR (5-Thn)</p>
      ...
      <div className="bg-white rounded-3xl shadow-sm border border-slate-200/80 p-6 md:p-8">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-6 gap-4">
          <div>
            <h3 className="text-xl font-extrabold text-slate-900">Drivers Strategis Utama</h3>
            <p className="text-xs text-slate-500 font-medium mt-0.5">Metrik pertumbuhan operasional inti dan proyeksi dampaknya pada ROI.</p>
          </div>
          <button 
            ...
            return (
              <table className="w-full text-left border-collapse">
                <thead className="bg-slate-50/80 border-b border-slate-200">
                  <tr>
                    <th className="px-6 py-4 text-xs font-bold text-slate-500 uppercase tracking-wider whitespace-nowrap">Nama Driver</th>
                    <th className="px-6 py-4 text-xs font-bold text-slate-500 uppercase tracking-wider whitespace-nowrap">Nilai (FY2025)</th>
                    <th className="px-6 py-4 text-xs font-bold text-slate-500 uppercase tracking-wider whitespace-nowrap">Pertumbuhan (s.d 2029)</th>
                    <th className="px-6 py-4 text-xs font-bold text-slate-500 uppercase tracking-wider whitespace-nowrap">Dampak ROI</th>
                    <th className="px-6 py-4 text-xs font-bold text-slate-500 uppercase tracking-wider text-right whitespace-nowrap">Status</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-100">
                  {/* Churn Row */}
                  <tr className="hover:bg-slate-50/60 transition-colors">
                    <td className="px-6 py-4 text-sm font-semibold text-slate-900 whitespace-nowrap">Churn Rate Bulanan</td>
                  ...
                  {/* ARPU Row */}
                  <tr className="hover:bg-slate-50/60 transition-colors">
                    <td className="px-6 py-4 text-sm font-semibold text-slate-900 whitespace-nowrap">ARPU (Average Revenue Per User)</td>
                  ...
                  {/* CAC Row */}
                  <tr className="hover:bg-slate-50/60 transition-colors">
                    <td className="px-6 py-4 text-sm font-semibold text-slate-900 whitespace-nowrap">Customer Acquisition Cost (CAC)</td>
