...
class AssumptionValue extends Model
{
    ...
    protected $casts = [
        'year' => 'integer',
        'beginning_cooperatives' => 'integer',
        'hr_engineering_fte' => 'integer',
        'hr_sales_fte' => 'integer',
        'hr_marketing_fte' => 'integer',
        'hr_support_fte' => 'integer',
        'hr_finance_admin_fte' => 'integer',
        'hr_management_fte' => 'integer',
        'hr_avg_salary_monthly' => 'float',
